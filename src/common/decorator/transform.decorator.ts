...
export function ValidateIfNotEmpty(): (object: unknown, propertyName: string) => void {
 ...
 * index(){...}
 */
export function ResponseSerialize<T>(cls: ClassType<T>, isSwaggerResponse = true): MethodDecorator {
